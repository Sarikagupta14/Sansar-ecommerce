...
const Beauty = () => {
    // Getting data in the form of email from signin to match the users login
    ...
    const fetchApi=async()=>{
        try{
            const res= await fetch ('https://jsonserver-production-f85d.up.railway.app/beautyData')
...
/>
    ...
    <Heading color={'white'}>Beauty Products</Heading>
    <SimpleGrid gap={'50px'}
    columns={[1,2,3,4]}>
        {
      data && data
