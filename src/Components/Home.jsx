...
{/* second data  */}
<Box border={'2px solid gray'} m={'auto'}  mt={'10px'} w={{base:'80%',md:'80%',lg:'20%'}}>
<Heading p={'5px'} color={'black'} fontSize={{base:'20px',md:'20px',lg:'25px'}} align="center"  textDecorationStyle={'double'} textDecorationLine={'blink'}>Popular Categories</Heading>
</Box>
<SimpleGrid gap={'50px'}
            w={'80%'}
            m={'auto'}
