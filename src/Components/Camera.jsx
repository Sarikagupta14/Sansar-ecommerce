      ...
      data && data.filter((item) => {
        ...
        .map((item)=>{
            return(
              ...
              <Image borderRadius={'20px'}  h={'180px'} w={'210px'} src={item.image} alt=''/>
              ...
              <Flex ml={'5px'} gap={'10px'}>
               ...
               <Text fontSize={'15px'} fontWeight={'500'} color={'gray'} textDecoration="line-through" textDecorationColor="red">(₹{item.discountprice})</Text>
              </Flex>
