...
const Camera = () => {
    ...
    const fetchApi=async()=>{
        ...
        try{
            const res= await fetch ('https://jsonserver-production-f85d.up.railway.app/CameraData')
...
/>
    ...
    <Heading color={'white'}> Camera</Heading>
<SimpleGrid gap={'50px'}
columns={[1,2,3,4]}>{
    ...
    .map((item)=>{
        return(
            ...
            <Image  borderTopLeftRadius={'15px'} h={'250px'} w={'250px'} src={item.image} alt=''/>
            ...
            <Flex ml={'5px'} gap={'10px'}>
             ...
             <Text fontSize={'18px'} fontWeight={'600'} color={'red'} textDecoration="line-through" textDecorationColor="red">(₹{item.discountprice})</Text>
            </Flex>
